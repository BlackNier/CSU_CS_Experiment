...
function foo(response) {
  ...
  if (data && data[0]) {
    ...
    url += '/index';
    var script = document.createElement('script');
    document.getElementsByClassName('edit_history')[0].setAttribute('href', `https://github.com/leo6033/CSU_CS_Experiment/commits/master/docs/${url}`);
    script.src = `https://api.github.com/repos/leo6033/CSU_CS_Experiment/commits?path=docs/${url}&callback=foo`;
...
if (url == "/index.md") {
  // HomePage
  document.getElementsByClassName('edit_history')[0].setAttribute('href', `https://github.com/leo6033/CSU_CS_Experiment/commits/master/docs/index.md`);
  script.src = `https://api.github.com/repos/leo6033/CSU_CS_Experiment/commits?path=docs/index.md&callback=foo`;
  document.getElementsByTagName('head')[0].appendChild(script);
  ...
  document.getElementsByClassName('edit_history')[0].setAttribute('href', `https://github.com/leo6033/CSU_CS_Experiment/commits/master`);
